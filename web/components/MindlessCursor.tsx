...
export default function MindlessCursor({
  ...
  return (
    <div
      className={`relative h-40 w-full overflow-hidden rounded-2xl border border-zombie-light/25 bg-surface/80 shadow-glow-sm ${className}`}
      aria-hidden="true"
    >
      ...
      <div className="absolute left-10 top-8 motion-safe:animate-cursor-loop">
        {/* click ripple */}
        <span className="absolute -left-1 -top-1 block h-6 w-6 rounded-full border-2 border-zombie-light motion-safe:animate-click-pulse" />
        <svg width="26" height="26" viewBox="0 0 26 26" className="drop-shadow">
          <path
