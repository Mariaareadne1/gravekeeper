...
export default function Stat({
  ...
  return (
    <div className="rounded-2xl border border-zombie-light/50 bg-surface p-6 shadow-sm">
      <div className="font-display text-4xl font-bold text-zombie-light sm:text-5xl">
